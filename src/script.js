...
directionalLight.position.set(2.25, 0);
...
const hemisphhereLight = new THREE.HemisphereLight(0xff0000, 0x0000ff, 0.3);
scene.add(hemisphhereLight);
gui.add(hemisphhereLight, "intensity").min(0).max(1).step(0.01);
